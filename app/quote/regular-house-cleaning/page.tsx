...
export default function RegularHouseCleaningQuote() {
  ...
  const [formData, setFormData] = useState({
    ...
    cleaningFrequency: "One-off Clean",
                  ...
                  <AnimatePresence mode="wait">
                    {step === 1 ? (
                      ...
                      >
                        ...
                        <div className="space-y-4">
                          <div>
                            <h4 className="text-sm sm:text-base font-extrabold text-foreground">Cleaning Frequency</h4>
                            <p className="text-xs text-muted-foreground">How often should we visit your property?</p>
                          </div>
                          <div className="flex flex-wrap gap-2.5">
                            {["One-off Clean", "Daily", "Weekly", "Fortnightly", "Monthly"].map((freq) => {
                              const isSelected = formData.cleaningFrequency === freq;
                              return (
                                <button
                                  type="button"
                                  key={freq}
                                  onClick={() => setFormData({ ...formData, cleaningFrequency: freq })}
            ...
            >
              <div className="bg-card text-card-foreground rounded-3xl p-8 sm:p-12 border border-border shadow-lg relative overflow-hidden flex flex-col items-center">
                ...
                <div className="w-full max-w-md bg-secondary/50 rounded-2xl p-5 mb-8 border border-border/80 text-left text-xs sm:text-sm space-y-2">
                  ...
                  <p><span className="text-muted-foreground font-medium">Cleaning Frequency:</span> <span className="font-semibold text-foreground">{formData.cleaningFrequency}</span></p>
